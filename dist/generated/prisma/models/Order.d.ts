...
export type OrderOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "orderNumber" | "amount" | "discount" | "tax" | "totalAmount" | "status" | "paymentId" | "paymentMethod" | "couponCode" | "receipt" | "createdAt" | "updatedAt" | "userId" | "courseId", ExtArgs["result"]["order"]>;

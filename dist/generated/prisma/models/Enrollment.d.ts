...
export type EnrollmentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "status" | "progress" | "enrolledAt" | "expiresAt" | "completedAt" | "userId" | "courseId", ExtArgs["result"]["enrollment"]>;

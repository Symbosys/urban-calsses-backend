...
// @ts-nocheck 
/*
 * This file exports the `OfflineCenter` model and its related types.
 *
...
export type GetOfflineCenterAggregateType<T extends OfflineCenterAggregateArgs> = {
      [P in keyof T & keyof AggregateOfflineCenter]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateOfflineCenter[P]>
    : Prisma.GetScalarType<T[P], AggregateOfflineCenter[P]>
}
...
type GetOfflineCenterGroupByPayload<T extends OfflineCenterGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<OfflineCenterGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof OfflineCenterGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], OfflineCenterGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], OfflineCenterGroupByOutputType[P]>
      }
    >
  >
...
export type OfflineCenterCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<OfflineCenterFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface OfflineCenterDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['OfflineCenter'], meta: { name: 'OfflineCenter' } }
  /**
   ...
   * })
  **/
  count<T extends OfflineCenterCountArgs>(
    args?: Prisma.Subset<T, OfflineCenterCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], OfflineCenterCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends OfflineCenterGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, OfflineCenterGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOfflineCenterGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

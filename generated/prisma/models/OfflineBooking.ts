...
// @ts-nocheck 
/*
 * This file exports the `OfflineBooking` model and its related types.
 *
...
export type GetOfflineBookingAggregateType<T extends OfflineBookingAggregateArgs> = {
      [P in keyof T & keyof AggregateOfflineBooking]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateOfflineBooking[P]>
    : Prisma.GetScalarType<T[P], AggregateOfflineBooking[P]>
}
...
type GetOfflineBookingGroupByPayload<T extends OfflineBookingGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<OfflineBookingGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof OfflineBookingGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], OfflineBookingGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], OfflineBookingGroupByOutputType[P]>
      }
    >
  >
...
export type OfflineBookingCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<OfflineBookingFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface OfflineBookingDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['OfflineBooking'], meta: { name: 'OfflineBooking' } }
  /**
   ...
   * })
  **/
  count<T extends OfflineBookingCountArgs>(
    args?: Prisma.Subset<T, OfflineBookingCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], OfflineBookingCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends OfflineBookingGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, OfflineBookingGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOfflineBookingGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

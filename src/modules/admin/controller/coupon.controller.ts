...
export const createCoupon = asyncHandler(async (req, res, next) => {
  ...
  if (validation.description !== undefined) createData.description = validation.description;
  if (validation.minOrderAmount !== undefined) createData.minOrderAmount = validation.minOrderAmount;
  if (validation.maxUses !== undefined) createData.maxUses = validation.maxUses;
  if (validation.isActive !== undefined) createData.isActive = validation.isActive;
...
export const updateCoupon = asyncHandler(async (req, res, next) => {
  ...
  if (validation.discountValue !== undefined) updateData.discountValue = validation.discountValue;
  if (validation.minOrderAmount !== undefined) updateData.minOrderAmount = validation.minOrderAmount;
  if (validation.maxUses !== undefined) updateData.maxUses = validation.maxUses;
  if (validation.validFrom !== undefined) updateData.validFrom = validation.validFrom;
  if (validation.validTill !== undefined) updateData.validTill = validation.validTill;

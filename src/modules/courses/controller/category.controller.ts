...
export const updateCategory = asyncHandler(async (req, res, next) => {
  ...
  if (!existing) return next(new ErrorResponse("Category not found", 404));
...
export const getSubCategoryById = asyncHandler(async (req, res, next) => {
  ...
  if (!subCategory) return next(new ErrorResponse("Sub-category not found", 404));
...
export const updateSubCategory = asyncHandler(async (req, res, next) => {
  ...
  if (!existing) return next(new ErrorResponse("Sub-category not found", 404));

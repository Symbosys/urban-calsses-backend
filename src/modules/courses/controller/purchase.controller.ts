 ...
 */
export const checkout = asyncHandler(async (req: any, res, next) => {
 ...
 * @access  Private (Student)
 */
export const verifyPayment = asyncHandler(async (req: any, res, next) => {
 ...
 * @access  Private (Student)
 */
export const checkEnrollment = asyncHandler(async (req: any, res, next) => {
